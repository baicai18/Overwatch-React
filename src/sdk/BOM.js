...
var BOM = {
    getBOMDefinition: ()=> {
        return new Promise(async (resolve, reject)=>{
            try{
                let response = await fetcher(process.env.REACT_APP_APISERVER + '/api/boms/definition/active');
                if(response.ok){
    ...
    getFieldTypes: ()=> {
        return new Promise(async (resolve, reject) =>{
            try{
                let response = await fetcher(process.env.REACT_APP_APISERVER + '/api/boms/fieldTypes');
                if(response.ok){
                    resolve(await response.json())
                }else{
                    reject(await response.text());
    ...
    getDefaultBOMOutput: ()=> {
        return new Promise(async (resolve, reject) =>{
            try{
                let response = await fetcher(process.env.REACT_APP_APISERVER + '/api/boms/output/default');
                if(response.ok){
                    resolve(await response.json())
                }else{
                    reject(await response.text());
    ...
    getParser: (parserName)=> {
        return new Promise(async (resolve, reject) =>{
            try{
                let response = await fetcher(process.env.REACT_APP_APISERVER + '/api/boms/parser/' + (parserName?parserName:''));
                if(response.ok){
                    resolve(await response.json())
                }else{
                    reject(await response.text());
    ...
    deleteParser: (parserName)=> {
        return new Promise(async (resolve, reject)=>{
            try{
                let response = await fetcher(process.env.REACT_APP_APISERVER + '/api/boms/parser/' + parserName, {
                    method: 'DELETE'
                })
                if(response.ok){
                    resolve(true);
    ...
    getParsers: ()=> {
        return new Promise(async (resolve, reject)=>{
            try{
                let response = await fetcher(process.env.REACT_APP_APISERVER + '/api/boms/parsers', )
                if(response.ok){
                    resolve(await response.json());
                }else{
                    reject(await response.text());
    ...
    saveParser: parserOptions=>{
        return new Promise(async (resolve, reject)=>{
            try{
                let response = await fetcher(process.env.REACT_APP_APISERVER + '/api/boms/parser', {
                    method: 'POST',
    ...
    saveDefinition: bomDefinition=>{
        return new Promise(async (resolve, reject)=>{
            try{
                let response = await fetcher(process.env.REACT_APP_APISERVER + '/api/boms/definition', {
                    method: 'POST',
    ...
    saveOutput: bomOutput=>{
        return new Promise(async (resolve, reject)=>{
            try{
                let response = await fetcher(process.env.REACT_APP_APISERVER + '/api/boms/output', {
                    method: 'POST',
