...
class QuotationDeliverable extends React.Component{

    constructor(props){
        super(props);
        this.state = {
            show:false,
            rfq_number:props.rfq_number||null,
    ...
    deliverableBody(type){
        switch(type){
            case 'bom':
                return <BomSubmit rfq_number={this.state.rfq_number} project={this.state.project} revision={this.state.revision} requirement={this.state.requirement} deliverable={this.state.deliverable} onSaved={this.onSaved}/>;
                break;
            case 'file':
                return <FileSubmit rfq_number={this.state.rfq_number}  project={this.state.project} revision={this.state.revision} requirement={this.state.requirement} deliverable={this.state.deliverable} onSaved={this.onSaved}/>;
                //return "File";
            case 'form':
                return <FormSubmit rfq_number={this.state.rfq_number}  project={this.state.project} revision={this.state.revision} requirement={this.state.requirement} deliverable={this.state.deliverable} onSaved={this.onSaved}/>;
                //return "Form";
            default:
                return 'NONE';
    }
...
export default  QuotationDeliverable;