                ...
                <Card.Body className="card-body-thin">
                        <Form.Row>
                            ...
                            <Form.Group  className="col-md-3">
                                ...
                                <Form.Control as="select" size="sm" onChange={this.controlChanged} value={this.state.field.type} name="type" readOnly={false&&this.state.field._id != null}>
                                    <option value="" ></option>
                            ...
                            <Form.Group  className="col-md-3">
                                ...
                                <Form.Control as="select" size="sm" onChange={this.controlChanged} value={this.state.field.requiredRole} name="requiredRole" readOnly={false&&this.state.field._id != null}>
                                    <option value="" ></option>
                                    {
                                        this.props.roles?
                                        this.props.roles.map((role)=>{
                                            return <option value={role.role_code}>{role.role_code}</option>
                                        })
                                        :null
                                    }
                                    {/* <option value="Blank" >Blank Space</option>
                        ...
                        }
                        {
                            ...
                            <ChecklistFields formData={this.state.field.formData} onFormDataChanged={this.onFormDataChanged}/>
                            :''
                        }
                </Card.Body>
                {/* <Card.Body>
